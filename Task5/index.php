...
$brandArry = $brandModel->getAllBrands()->fetch_all(MYSQLI_ASSOC);
if ($productModel->getLatestProducts()) {
    $latestArry =  $productModel->getLatestProducts()->fetch_all(MYSQLI_ASSOC);
}
if ($productModel->getMostOrderedProducts()) {
    $mostOrderedArry =  $productModel->getMostOrderedProducts()->fetch_all(MYSQLI_ASSOC);
}
...
<div class="product-area bg-image-1 pt-100 pb-95">
    <div class="container">
        <div class="row">
            <?php foreach ($brandArry as $brand) { ?>
                <div class="col-3">
...
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        ...
        <div class="row">
            <?php foreach ($latestArry as $latestProduct) { ?>
                <div class="col-3 ">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img alt="" src="assets/img/product/<?= $latestProduct['image'] ?>">
                        </a>
                    ...
                    <div class="product-content text-left">
                        <div class="product-hover-style">
                            <div class="product-title">
                                <h4>
                                    <a href="product-details.html"><?= $latestProduct['name_en'] ?></a>
                                </h4>
                            </div>
                        ...
                        <div class="product-price-wrapper">
                            ...
                            <span class="product-price"><?= $latestProduct['price'] ?> EGP </span>
                        </div>
                    </div>
                </div>
            <?PHP } ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <?php foreach ($mostOrderedArry as $mostOrderedProduct) { ?>
                <div class="col-3 ">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img alt="" src="assets/img/product/<?= $mostOrderedProduct['image'] ?>">
                        </a>
                    ...
                    <div class="product-content text-left">
                        <div class="product-hover-style">
                            <div class="product-title">
                                <h4>
                                    <a href="product-details.html"><?= $mostOrderedProduct['name_en'] ?></a>
                                </h4>
                            </div>
                            <div class="cart-hover">
                                <h4><a href="product-details.html">+ Add to cart</a></h4>
                        ...
                        <div class="product-price-wrapper">
                            ...
                            <span class="product-price"><?= $mostOrderedProduct['price'] ?> EGP </span>
                        </div>
                    </div>
                </div>
            <?PHP } ?>
