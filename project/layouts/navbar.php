...
use APP\DB\Models\Subcategory;
 ...
 $categoryArry = $categoryModel->getAllCategories()->fetch_all(MYSQLI_ASSOC);
//  print_r($categoryArry);die;
 //;
                                    ...
                                    <nav>
                                        <ul>
                                            ...
                                            <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                                <ul class="mega-menu">
                                                    <?php
                                                    foreach($categoryArry AS $category){
                                                        $subcategoryModel->setCategory_id($category['id']);
                                                        $subcategoryArry = $subcategoryModel->getSubcategoriesByCategory()->fetch_all(MYSQLI_ASSOC);
                                                    
                                                    ?>
                                                    <li>
                                                        <ul>
                                                            <li class="mega-menu-title"><a href="shop.php?category=<?= $category['id'] ?>"><?= $category['name_en'] ?></a></li>
                                                           <?php  foreach($subcategoryArry AS $subcategory){ ?>
