...
class Subcategory extends Model{
    ...
    public function getSubcategoriesByCategory(){
        $query = "SELECT name_en,id FROM subcategories  WHERE status = " . self::ACTIVE . " AND category_id = ?";
    ...
    {
        $query = "SELECT name_en,id FROM subcategories  WHERE status = " . self::ACTIVE . " AND id = ?";
        $stmt = $this->con->prepare($query);
        if(! $stmt){ 
            return $stmt;
        }
